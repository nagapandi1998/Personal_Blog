            ...
            <div className="row">
                <div className="experience-col-3">
                    ...
                    <h1 data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" data-aos-offset="200">
                        Achievements</h1>
                    <ul data-aos="zoom-in-right" data-aos-offset="300" className="achivement-list">
                        <div>
                        <li className='achivement-list'>Completed HTML5, CSS3, JS, ReactJS in FITA Academy</li>
                        <li className='achivement-list'>Completed SAP certified with 85% in Material Management</li>
