            ...
            <div className="container">
                <div className="row">
                    <div className="experience-col-3">
                        ...
                        <br />
                        <h1 className='pinkname' data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" data-aos-offset="200">
                            Achievements</h1>
                        ...
                        <br />
                        <h1 className='pinkname' data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" data-aos-offset="200">Courses</h1>
                        <ul>
